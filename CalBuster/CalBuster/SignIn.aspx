...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="signIn">
        ...
        <p><asp:Label ID="lblFirstName" runat="server" Text="*First name:" CssClass="labels"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="rfvFname" runat="server" ControlToValidate="txtFirstName" Display="Dynamic" ErrorMessage="First name required" SetFocusOnError="True" Visible="False"></asp:RequiredFieldValidator>
            ...
            <asp:RequiredFieldValidator ID="rfvSurname" runat="server" ControlToValidate="txtSurame" Display="Dynamic" ErrorMessage="Surname required" SetFocusOnError="True" Visible="False"></asp:RequiredFieldValidator>
        ...
        <p>
         <asp:Label ID="lblCreateUserName" runat="server" Text="*Create UserName" CssClass="labels"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="rfvUserName" runat="server" ControlToValidate="txtCreateUserName" Display="Dynamic" ErrorMessage="UserName required" SetFocusOnError="True" Visible="False">UserName required</asp:RequiredFieldValidator>
        ...
        <p>
         <asp:Label ID="lblPassword" runat="server" Text="*Create Password" CssClass="labels"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="rfvPassword1" runat="server" ControlToValidate="txtCreatePassword" Display="Dynamic" ErrorMessage="Password Required" SetFocusOnError="True" Visible="False"></asp:RequiredFieldValidator>
            </p>
                <p>
         <asp:Label ID="lblConfirmPassword" runat="server" Text="*Confirm Password" CssClass="labels"></asp:Label>
            ...
            <asp:TextBox ID="txtConfirmPassword" runat="server" CssClass="highightTextbox"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvConPassword" runat="server" ControlToValidate="txtConfirmPassword" Display="Dynamic" ErrorMessage="Must re-enter password" Visible="False"></asp:RequiredFieldValidator>
        ...
        <p>
         <asp:Label ID="lblEmail" runat="server" Text="*Email adress" CssClass="labels"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="txtEmail" Display="Dynamic" ErrorMessage="Email Required" SetFocusOnError="True" Visible="False"></asp:RequiredFieldValidator>
        ...
        <p>
         <asp:Label ID="lblConfirmEmail" runat="server" Text="*Re-enter email adress" CssClass="labels"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="rfvConEmail" runat="server" ControlToValidate="txtConfirmEmail" Display="Dynamic" ErrorMessage="Email confirmation required" Visible="False"></asp:RequiredFieldValidator>
        ...
        <p>
            ...
            <asp:RequiredFieldValidator ID="rfvGender" runat="server" ControlToValidate="rdlGender" Display="Dynamic" ErrorMessage="Gender must be selected" SetFocusOnError="True" Visible="False"></asp:RequiredFieldValidator>
        </p>
         ...
         <asp:Label ID="lblDOB" runat="server" Text="*Date of birth" CssClass="labels"></asp:Label>
            ...
            <asp:TextBox ID="txtDay" runat="server" placeholder="DD/MM/YYYY" CssClass="highightTextbox"></asp:TextBox>
                 <asp:RegularExpressionValidator ID="rxvDOB" runat="server" ControlToValidate="txtDay" ErrorMessage="Date must be DD/MM/YYYY" SetFocusOnError="True" ValidationExpression="^(((0[1-9]|[12]\d|3[01])\/(0[13578]|1[02])\/((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)\/(0[13456789]|1[012])\/((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])\/02\/((19|[2-9]\d)\d{2}))|(29\/02\/((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$"></asp:RegularExpressionValidator>
